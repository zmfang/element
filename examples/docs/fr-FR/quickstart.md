...
```javascript
import Vue from 'vue';
import ElementUI from 'apexsoft-element-ui';
import 'apexsoft-element-ui/lib/theme-chalk/index.css';
...
```json
{
  ...
  "plugins": [
    [
      "component",
      {
        "libraryName": "apexsoft-element-ui",
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'apexsoft-element-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'apexsoft-element-ui';
