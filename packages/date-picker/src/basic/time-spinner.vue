...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'apexsoft-element-ui/src/utils/date-util';
  import ElScrollbar from 'apexsoft-element-ui/packages/scrollbar';
  import RepeatClick from 'apexsoft-element-ui/src/directives/repeat-click';
