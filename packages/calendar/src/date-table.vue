<script>
import fecha from 'apexsoft-element-ui/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'apexsoft-element-ui/src/utils/date-util';
